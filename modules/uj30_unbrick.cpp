#include "uj30_unbrick.h"

UJ30_Unbrick::UJ30_Unbrick(QWidget *parent)
{
...
UJ30_Unbrick::~UJ30_Unbrick()
{

}

bool UJ30_Unbrick::sendKernelToRam()
{
    QByteArray output;
    QByteArray received;

    QString filename_kernel = "./kernels/uj30_kernel.bin";
    ...
    {
        emit send_logwindow_message("Uploading UJ30 kernel, please wait...", true, true);
...
bool UJ30_Unbrick::sendFileToFlash()
{
    QByteArray output;
    QByteArray received;
...
bool UJ30_Unbrick::unbrick_uj30()
{
    int baudRateComboBoxIndex = emit get_baudrate_combobox_index();
    int parityComboBoxIndex = emit get_parity_combobox_index();
...
bool UJ30_Unbrick::open_serialport()
{
...
uint8_t UJ30_Unbrick::calculate_checksum(QByteArray output, bool dec_0x100)
{
    uint8_t checksum = 0;
...
QString UJ30_Unbrick::parse_message_to_hex(QByteArray received)
{
    QByteArray msg;
...
void UJ30_Unbrick::delay(int timeout)
{
